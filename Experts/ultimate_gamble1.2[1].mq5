      ...
      {  
        ...
        else if (maxt > 1 )
        {
         for(int i= 1; i< maxt+1; i++)
           {
            trade.BuyStop(0.2,Ask+(10*i),_Symbol,Ask+(10*i)-30,Ask+(10*i)+30,ORDER_TIME_GTC,0,NULL);
       ...
       double tp = Bid - 100;
        if (maxt == 1)
        {
            ...
            trade.Sell(0.2,NULL,Bid,Bid+40,Bid-30,NULL );
        }
        else if (maxt>1)
        
        {
           ...
           {
            trade.SellStop(0.2,Bid-(10*i),_Symbol,Bid-(10*i)+30,Bid-(10*i)-30,ORDER_TIME_GTC,0,NULL);
           } 
        }
